...
interface PhoneNumberModelState {
    ...
    areaCodeOptions: OptionTypeBase[];
...
export class PhoneNumberModal extends React.Component<PhoneNumberModelProps, PhoneNumberModelState> {
    ...
    private setAreaCodeList = (areaCodeList: AreaCodeInfo[]) => {
        let areaCodeOptions: OptionTypeBase[] = [];
        areaCodeList.map((info) => {
            areaCodeOptions.push({
    ...
    private handleAreaCodeChange = (value: string, event: React.FormEvent<HTMLSelectElement>) => {
